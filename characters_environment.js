...
function play(){
  game_status = "start";
  document.getElementById("status").innerHTML = "Game Is loading please get prepared"
}
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press the bright 'play game' button above the game to Start and Play ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
